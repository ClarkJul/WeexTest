...
import com.android.clark.weextest.common.CommonUtils;
import com.android.clark.weextest.common.Constants;
import com.android.clark.weextest.common.WeexDialogParams;
import com.android.clark.weextest.common_demo.DQWeexListener;
import com.android.clark.weextest.common_demo.WeexInstanceManager;
...
public class WeexDialogActivity extends AppCompatActivity implements DQWeexListener{
    ...
    private void initData() {
        ...
        tv_info.setText("本实例需要连接本地server访问目标js文件，根据实际情况配置好服务端js，测试weex窗口的创建，关闭，显示与隐藏等功能");
        btnChange.setText("重新渲染Weex页面");
    }
